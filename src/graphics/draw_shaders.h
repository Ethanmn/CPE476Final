...
struct DrawShader {
   ...
   void Draw(ShadowMapFBO shadow_map_fbo_, std::vector<Drawable> drawables, glm::mat4 viewMatrix,
  ...
  private:
   void setupDrawShader(Shader& shader, ShadowMapFBO shadow_map_fbo_, glm::mat4 viewMatrix,
      glm::vec3 sunDir, float sunIntensity, int lightning);
