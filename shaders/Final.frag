...
float calculateShadowAmount(vec4 depthOfImage, vec2 texCoord);
...
float calculateShadowAmount(vec4 depthOfImage, vec2 texCoord) {
   ...
   /*vec2 shadowCoord = (uShadowMap * depthOfImage).xy; */

   /*if(uHasShadows != 0) {*/
      /*shadowMapTexColor = texture2D(uShadowMapTexture, shadowCoord);*/
      /*if(texCoord.x > 1.0 || texCoord.y > 1.0 || texCoord.x < 0.0 || texCoord.y < 0.0) {*/
         /*shadowMapTexColor.z = 1.0;*/
      /*}*/
   /*}*/
   /*if(shadowMapTexColor.z <= depthOfImage.z - bias)*/
      /*applyShadow = 0.7;*/
